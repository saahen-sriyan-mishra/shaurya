    ...
    try {
      const response = await fetch("https://api.web3forms.com/submit", {
        ...
        body: JSON.stringify({
          ...
          subject: "New DWS Training Application",
        ...
        <div className="w-full flex flex-col">
          ...
          <div className="w-full flex" style={{ height: '5rem' }}>
            ...
            <div className="w-[93%] flex items-center">
              ...
              <h1 style={{ color: blueColor }} className="text-4xl font-bold ml-4">DWS Training Application</h1>
            </div>
          </div>
      ...
      <div className="md:hidden">
        <div className="w-full flex flex-col">
          ...
          <div className="w-full flex items-center bg-white p-4" style={{ height: '4rem' }}>
            ...
            <h1 style={{ color: blueColor }} className="text-2xl font-bold">DWS Training Application</h1>
          </div>
